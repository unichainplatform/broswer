...
export default class TransactionTable extends Component {
  ...
  onSearch = async (value) => {
    ...
    if (hash.indexOf('0x') === 0) {
      let txInfo = await unichain.uni.getTransactionByHash(hash);
      if (txInfo != null) {
        const txReceiptData = await unichain.uni.getTransactionReceipt(hash);//formatHighlight(await unichain.uni.getTransactionReceipt(hash), COLOR_OPTION);
