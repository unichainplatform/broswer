...
ShareCoding.prototype = {
  ...
  enableShare : function ()  {
    const payload = '0x' + unichain.utils.getContractPayload('enableShare', [], []);
  ...
  disableShare : function ()  {
    const payload = '0x' + unichain.utils.getContractPayload('disableShare', [], []);
    const txInfo = { actionType: Constant.CALL_CONTRACT,
      toAccountName: this.contractAccountName,
      assetId: 0,
      amount: 0,
  ...
  addAcceptToken : function (tokenIds)  {
    const payload = '0x' + unichain.utils.getContractPayload('addAcceptToken', ['uint256[]'], tokenIds);
    const txInfo = { actionType: Constant.CALL_CONTRACT,
      toAccountName: this.contractAccountName,
      assetId: 0,
      amount: 0,
  ...
  removeAcceptToken : function (tokenIds)  {
    const payload = '0x' + unichain.utils.getContractPayload('removeAcceptToken', ['uint256[]'], tokenIds);
    const txInfo = { actionType: Constant.CALL_CONTRACT,
      toAccountName: this.contractAccountName,
      assetId: 0,
      amount: 0,
  ...
  giveReward : function (toCoder) {
    const payload = '0x' + unichain.utils.getContractPayload('giveReward', ['address'], toCoder);
    const txInfo = { actionType: Constant.CALL_CONTRACT,
      toAccountName: this.contractAccountName,
      assetId: 0,
      amount: 0,
