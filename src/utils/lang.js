const ch2en = {
  ...
  "新增账户":"Add account",
  "导入账户":"Import account",
  "首个主网账户请找第三方申请，如是首个测试网账户可上公链电报群(https://t.me/UnichainOfficial)进行申请，申请成功后请将私钥和账户导入即可使用。":"For the first main network account, please apply for a third party. If the first test network account can be applied to the public chain telegram group(https://t.me/UnichainOfficial), please import the private key and account after the application is successful.",
  ...
  "最近一次DPOS相关操作的区块高度": 'lastest DPos action',
  '总出块数': 'total blocks',
  ...
  '抵押票数固定为50万UNI': 'please input 500000 UNI',
  '添加合约': 'Add Contract',
  '删除选中合约': 'Del Contract',
  '我的合约': 'My Contracts',
  ...
  'UNI余额不足，无法发起交易': 'Amount of UNI is not enough, can not send tx',
  '部署合约的交易hash:': 'the tx hash of deploying contract',
  ...
  '请输入UNI转账金额': 'Please input amount of transferring UNI token',
  '创建账户的交易hash:': 'the tx hash of creating account',
